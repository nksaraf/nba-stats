...
public class TeamDashboard extends Dashboard {
		...
		GENERAL_SPLITS("dashboardbygeneralsplits"), OPPONENT_SPLITS("dashboardbyopponent"), LAST_N_GAMES_SPLITS(
				"dashboardbylastngames"), SHOOTING_SPLITS("dashboardbyshootingsplits"), IN_GAME_SPLITS(
						"dashboardbygamesplits"), CLUTCH_SPLITS("dashboardbyclutch"), TEAM_PERFORMANCE_SPLITS(
								"dashboardbyteamperformace"), YEAR_OVER_YEAR_SPLITS("dashboardbyyearoveryear"), PLAYERS(
										"playerdashboard"), PLAYER_ON_OFF_DETAILS(
												"playeronoffdetails"), PLAYER_ON_OFF_SUMMARY(
														"playeronoffsummary"), SHOT_TRACKING(
																"dashptshots"), PASS_TRACKING(
																		"dashptpass"), REBOUND_TRACKING("dashptreb");
	...
	public enum ItemType implements Dashboard.ItemType {
		OVERALL_GENERAL(Type.GENERAL_SPLITS, 0), LOCATION(Type.GENERAL_SPLITS, 1), WIN_LOSSES(Type.GENERAL_SPLITS,
				2), MONTHLY(Type.GENERAL_SPLITS,
						3), PRE_POST_ALLSTAR(Type.GENERAL_SPLITS, 4), DAYS_REST(Type.GENERAL_SPLITS, 5),
		...
		OVERALL_SHOOTING(Type.SHOOTING_SPLITS, 0), SHOT_5FT(Type.SHOOTING_SPLITS, 1), SHOT_8FT(Type.SHOOTING_SPLITS,
				2), SHOT_AREAS(Type.SHOOTING_SPLITS, 3), ASSISSTED_SHOTS(Type.SHOOTING_SPLITS,
						4), SHOT_TYPES_SUMMARY(Type.SHOOTING_SPLITS, 5), ASSISSTED_BY(Type.SHOOTING_SPLITS, 6),
		...
		OVERALL_PLAYERS(Type.PLAYERS, 0), SEASON_TOTALS_PLAYERS(Type.PLAYERS, 1),

		OVERALL_ON_OFF_SUMMARY(Type.PLAYER_ON_OFF_SUMMARY, 0), ON_COURT_SUMMARY(Type.PLAYER_ON_OFF_SUMMARY,
				1), OFF_COURT_SUMMARY(Type.PLAYER_ON_OFF_SUMMARY, 2),

		OVERALL_ON_OFF_DETAILS(Type.PLAYER_ON_OFF_DETAILS, 0), ON_COURT_DETAILS(Type.PLAYER_ON_OFF_DETAILS,
				1), OFF_COURT_DETAILS(Type.PLAYER_ON_OFF_DETAILS, 2),

		OVERALL_SHOT_TRACKING(Type.SHOT_TRACKING, 0), SHOT_CLOCK_SHOOTING(Type.SHOT_TRACKING, 1), DRIBBLE_SHOOTING(
				Type.SHOT_TRACKING,
				2), CLOSEST_DEFENDER_SHOOTING(Type.SHOT_TRACKING, 3), CLOSEST_DEFENDER_SHOOTING_LONG(Type.SHOT_TRACKING,
						4), TOUCH_TIME_SHOOTING(Type.SHOT_TRACKING, 5),

		OVERALL_REB_TRACKING(Type.REBOUND_TRACKING, 0), SHOT_TYPE_REBOUNDING(Type.REBOUND_TRACKING,
				1), CONTESTED_REBOUNDING(Type.REBOUND_TRACKING, 2), SHOT_DISTANCE_REBOUNDING(Type.REBOUND_TRACKING,
						3), REBOUND_DISTANCE_REBOUNDING(Type.REBOUND_TRACKING, 4),

		OVERALL_PASS_TRACKING(Type.PASS_TRACKING, 0), PASSES_MADE(Type.PASS_TRACKING,
				1), PASSES_RECEIVED(Type.PASS_TRACKING, 2);
