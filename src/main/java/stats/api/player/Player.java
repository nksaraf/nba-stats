...
public class Player extends Element {
	...
	public Player(JSONArray details_array) {
		...
		String[] headers = { "ID", "FORMAL_NAME", "FULL_NAME", "ROSTER_STATUS", "FROM_YEAR", "TO_YEAR", "PLAYER_CODE",
				"TEAM_ID", "TEAM_CITY", "TEAM_NAME", "TEAM_ABBR", "TEAM_CODE", "GAMES_PLAYED_FLAG" };
	...
	public enum Feature implements Element.Feature {
		...
		SUMMARY("summary"), GAME_LOG("game_log"), DASHBOARD("dashboard"), CAREER("career"), SHOT_CHART("shotchart");
