...
public class ShotChart extends Statistic {
	...
	private static FieldType[] required_fields = { FieldType.PLAYER_ID, FieldType.TEAM_ID, FieldType.GAME_ID,
			FieldType.LEAGUE, FieldType.SEASON, FieldType.SEASON_TYPE, FieldType.OUTCOME, FieldType.LOCATION,
			FieldType.MONTH, FieldType.SEASON_SEGMENT, FieldType.DATE_FROM, FieldType.DATE_TO,
			FieldType.OPPONENT_TEAM_ID, FieldType.VS_CONFERENCE, FieldType.VS_DIVISION, FieldType.PLAYER_POSITION,
			FieldType.GAME_SEGMENT, FieldType.PERIOD, FieldType.LAST_N_GAMES, FieldType.AHEAD_BEHIND,
			FieldType.CONTEXT_MEASURE, FieldType.CLUTCH_TIME, FieldType.ROOKIE_YEAR };
