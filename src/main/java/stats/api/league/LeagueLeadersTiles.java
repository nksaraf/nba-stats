...
public class LeagueLeadersTiles extends Statistic {
	...
	private static FieldType[] required_fields = { FieldType.LEAGUE, FieldType.STAT, FieldType.SEASON,
			FieldType.SEASON_TYPE, FieldType.GAMESCOPE, FieldType.PLAYER_SCOPE, FieldType.PLAYER_OR_TEAM };
	...
	public enum ItemType implements Statistic.ItemType {
		CURRENT_SEASON_HIGH(0), ALLTIME_SEASON_HIGH(1), LAST_SEASON_HIGH(2), LOW_SEASON_HIGH(3);
