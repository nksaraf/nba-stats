...
public class LeagueLineups extends Statistic {
	...
	private static FieldType[] required_fields = { FieldType.GROUP_QUANTITY, FieldType.MEASURE_TYPE, FieldType.PER_MODE,
			FieldType.PLUS_MINUS, FieldType.PACE_ADJUST, FieldType.RANK, FieldType.SEASON, FieldType.SEASON_TYPE,
			...
			FieldType.GAME_SEGMENT, FieldType.PERIOD, FieldType.LAST_N_GAMES };
