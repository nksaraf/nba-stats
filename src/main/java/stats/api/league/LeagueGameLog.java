...
public class LeagueGameLog extends Statistic {
	...
	private static FieldType[] required_fields = { FieldType.LEAGUE, FieldType.SEASON, FieldType.SEASON_TYPE,
			FieldType.PLAYER_OR_TEAM, FieldType.COUNTER, FieldType.SORTER, FieldType.DIRECTION };
