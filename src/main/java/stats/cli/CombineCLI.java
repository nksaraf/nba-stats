...
static DraftCombine combine;
	...
	public static void get(String args[]) {
		try {
			...
			if(combine == null) throw new IllegalArgumentException("Combine not loaded");
			combineOptions(args);
			options(args);
	...
	static void combineOptions(String args[]) {
		switch(args[0]) {
			...
			default: {
				if(stat == null) throw new IllegalArgumentException("Illegal combine element option provided");
			}
		}
